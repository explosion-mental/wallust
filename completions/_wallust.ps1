...
Register-ArgumentCompleter -Native -CommandName 'wallust' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        ...
        'wallust;run' {
            ...
            [CompletionResult]::new('--config-path', 'config-path', [CompletionResultType]::ParameterName, 'Use FILE as the config file')
            [CompletionResult]::new('-d', 'd', [CompletionResultType]::ParameterName, 'Use DIR as the config directory')
            [CompletionResult]::new('--config-dir', 'config-dir', [CompletionResultType]::ParameterName, 'Use DIR as the config directory')
            [CompletionResult]::new('-p', 'p', [CompletionResultType]::ParameterName, 'Choose which palette to use (overwrites config)')
            [CompletionResult]::new('-f', 'f', [CompletionResultType]::ParameterName, 'Choose which palette to use (overwrites config)')
            [CompletionResult]::new('--palette', 'palette', [CompletionResultType]::ParameterName, 'Choose which palette to use (overwrites config)')
            [CompletionResult]::new('--filter', 'filter', [CompletionResultType]::ParameterName, 'Choose which palette to use (overwrites config)')
            [CompletionResult]::new('-g', 'g', [CompletionResultType]::ParameterName, 'Choose which generation method to use (overwrites config)')
            [CompletionResult]::new('--generation', 'generation', [CompletionResultType]::ParameterName, 'Choose which generation method to use (overwrites config)')
            ...
            [CompletionResult]::new('-T', 'T ', [CompletionResultType]::ParameterName, 'Skip the templating process')
            [CompletionResult]::new('--skip-templates', 'skip-templates', [CompletionResultType]::ParameterName, 'Skip the templating process')
            [CompletionResult]::new('-u', 'u', [CompletionResultType]::ParameterName, 'Only update the current terminal colros')
            [CompletionResult]::new('--update-current', 'update-current', [CompletionResultType]::ParameterName, 'Only update the current terminal colros')
