_wallust() {
    ...
    case "${cmd}" in
        wallust)
            opts="-I -q -s -T -u -C -d -N -h -V --ignore-sequence --quiet --skip-sequences --skip-templates --update-current --config-file --config-dir --templates-dir --no-config --no-hooks --help --version run cs theme migrate debug pywal help"
            ...
            ;;
        wallust__cs)
            opts="-f -I -q -s -T -u -C -d -N -h --format --ignore-sequence --quiet --skip-sequences --skip-templates --update-current --config-file --config-dir --templates-dir --no-config --no-hooks --help <COLORSCHEME>"
            ...
            ;;
        wallust__debug)
            opts="-I -q -s -T -u -C -d -N -h --ignore-sequence --quiet --skip-sequences --skip-templates --update-current --config-file --config-dir --templates-dir --no-config --no-hooks --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        wallust__migrate)
            ...
            ;;
        wallust__pywal)
            opts="-a -b -f -c -i -l -n -o -q -r -R -s -t -v -e -I -T -u -C -d -N -h --backend --theme --iterative --saturate --preview --vte --ignore-sequence --skip-templates --update-current --config-file --config-dir --templates-dir --no-config --no-hooks --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        wallust__run)
            opts="-a -b -c -f -k -n -p -t -w -I -q -s -T -u -C -d -N -h --alpha --backend --colorspace --fallback-generator --check-contrast --no-cache --palette --saturation --threshold --dynamic-threshold --overwrite-cache --save-scheme --print-scheme --ignore-sequence --quiet --skip-sequences --skip-templates --update-current --config-file --config-dir --templates-dir --no-config --no-hooks --help <FILE>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
